...
xcodebuild -project $PLUGIN_NAME.xcodeproj -target "APP" -configuration Release -arch x86_64 2> ./build-mac.log
xcodebuild -project $PLUGIN_NAME.xcodeproj -target "AU" -configuration Release -arch x86_64 2>> ./build-mac.log
xcodebuild -project $PLUGIN_NAME.xcodeproj -target "VST2" -configuration Release -arch x86_64 2>> ./build-mac.log
xcodebuild -project $PLUGIN_NAME.xcodeproj -target "VST3" -configuration Release -arch x86_64 2>> ./build-mac.log
...
#echo ""
#mv "${PKG}" "${PKG_US}"
#productsign --sign "${CERT_ID}" "${PKG_US}" "${PKG}"
