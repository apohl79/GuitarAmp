...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright OSAR Music, " + str(today.year)
  CFBundleVersion = FullVersionStr

  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."

  plistpath = scriptpath + "/resources/GuitarAmp-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarAmp-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarAmp-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarAmp-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarAmp-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarAmp-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/GuitarAmp-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/GuitarAmp.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/GuitarAmp.iss",inplace=1):
